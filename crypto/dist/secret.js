...
// secret.js
import * as x255193 from "npm:@stablelib/x25519";
...
var EncryptedExtensions2 = class extends Struct {
  type = HandshakeType.encrypted_extensions;
  constructor(extensions) {
    const extension2 = new VariableVector(extensions, 0, 2 ** 16 - 1);
    super(extension2);
  }
};
...
var Secret = class {
  ...
  serverMsg;
  // handshake
  extensionsMsg = new Handshake2(new EncryptedExtensions2(new Uint8Array(0)));
  // handshake
  certificateMsg;
  // handshake
  ...
  transcriptMsg;
  clientSide;
  key = { server: void 0, client: void 0 };
  iv = { server: void 0, client: void 0 };
  aead = { server: void 0, client: void 0 };
  // Aead class
  ...
  async encrypt() {
    const handshakeMsg = concat(this.extensionsMsg, this.certificateMsg, this.certificateVerifyMsg, this.finishedMsg, new Uint8Array([22]));
